"""Seed demo data (consolidated, latest schema) (dev-only).
...
def upgrade() -> None:
    # Seeding is consolidated into a later migration (after policy reuse mapping exists).
    return
    ...
    conn.execute(
        sa.text(
            ...
            VALUES
              ...
              (:policy_id, 'ROW', :effective_from, NULL, 'ACTUALS_CAPPED_TO_BENCHMARK_EX_VAT', NULL, 'EGHO', 1.10, 0)
            """
        ),
